...
$title = 'Fund Account - '.$sitename;
$thepage = 'Fund Account';
$thepagecode = 'load';
...
if (isset($_POST['load_aza'])) {
    ...
    if ($con->load_aza_user($load_account,$userid,$_POST['sender'],$_POST['amount'],$_POST['senderbank'],$_POST['description'],$BrowserInfo,$IpInfo)) {$erro="good";
    } else {
      $erro="fatal";
    }
}
...
<div class="alert alert-imaged alert-success alert-dismissible fade show mb-2" role="alert">
                        ...
                        <div>
                            Success! <?= $sitecurrencysym;?><?= number_format($_POST['amount']);?> has been added to your account balance.
                        </div>
                        <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                    </div>
...
<div class="wide-block pt-2 pb-2">
				...
				<div class="col-4 col-lg-4"><div class="form-group boxed">
                            <div class="input-wrapper">
                                ...
                                <input type="text" class="form-control" value="<?php if(isset($_GET['money'])){echo $_GET['money'];}?>" name="amount" id="text4b" placeholder="<?= $sitecurrencysym;?>">
                                <i class="clear-input">
				...
				<button class="btn btn-primary btn-block" name="load_aza" type="submit">Load Now</button>
				</form>
