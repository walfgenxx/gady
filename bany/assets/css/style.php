...
a {
  color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  outline: 0 !important;
...
.appHeader.bg-primary:before {
  background: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> !important;
}
...
.appBottomMenu .item .action-button {
  ...
  justify-content: center;
  border-radius: 200px;
  background: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
}
...
.appBottomMenu .item.active strong {
  color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> !important;
  font-weight: 500;
}
...
body.animationGoBack:after {
  ...
  bottom: 0;
  width: 100%;
  background-color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
...
.btn-primary {
  background: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> !important;
  border-color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> !important;
...
.btn-primary.disabled, .btn-primary:disabled {
  background: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  border-color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  opacity: 0.5;
}
...
.alert-primary {
  background: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  color: #fff;
  border: 1px solid <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
}
...
.alert-outline-primary {
  background: transparent;
  color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  border: 2px solid <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
}
...
.form-group.basic .custom-select:focus {
  border-bottom-color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  box-shadow: inset 0 -1px 0 0 <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
}
...
.nav-tabs.lined .nav-item .nav-link.active {
  color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  background: transparent;
  border-bottom-color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> !important;
}
...
.chip-primary.chip-outline {
  color: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> !important;
  box-shadow: inset 0 0 0 1px <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> !important;
}
...
.gradientSection {
  ...
  text-align: center;
  background: <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?>;
  background-image: linear-gradient(-208deg, <?php if(!empty($sitecolor)){echo $sitecolor;}else{echo '#6236FF';}?> 38%, #8a69ff 100%);
}
