...
if(isset($_GET['delete'])){ if($clear=$mysqli->query("DELETE FROM tickets WHERE ticketid=".$_GET['delete'])){
...
if(isset($_GET['approve'])){
	...
	$query1 = "SELECT * FROM tickets WHERE ticketid='".$_GET['approve']."'";
 ...
 $mycurrencysym = $row2['mycurrencysym'];
	...
	$update=$mysqli->query("UPDATE tickets SET "
						 . "status='closed'" . " WHERE ticketid=" .$_GET['approve']);
					 
						 
	$update=$mysqli->query("UPDATE transactions SET "
						 . "status='success'" . " WHERE transkey=" .$ticketid);

if($section=='Bitcoin Deposit'){
    $update=$mysqli->query("UPDATE btc_transactions SET "
						 . "status='success'" . " WHERE transkey=" .$ticketid);
}

$subject = 'APPROVED: Your Bank Deposit Ticket ['.$ticketid.'] Has Been Solved';
$datez = date('Y');
...
<div style="display: none; font-size: 1px; color: #fefefe; line-height: 1px; font-family: 'Poppins', sans-serif; max-height: 0px; max-width: 0px; opacity: 0; overflow: hidden;">
    Your Bank deposit ticket $ticketid has been solved!
</div>
               ...
               <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 <tr style="border-collapse:collapse"> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:530px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:15px"><h3 style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#333333">Hello $userbro, Your ticket [$ticketid] has been approved and marked as solved.</h3></td> 
                     </tr> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">The deposit ticket of $mycurrencysym$amountz into your has been approved and deposited into your bank account!<br /><br /><span style="color: red; font-weight: bold; font-size: 30px; display: block; text-align: center;">SOLVED</span><br />
                  ...
                  <td valign="top" align="center" style="padding:0;Margin:0;width:530px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     ...
                     <tr style="border-collapse:collapse"> 
					  ...
					  <b>Ticket ID:</b> $ticketid<br /><b>Subject:</b> $title<br /><b>Amount:</b> $mycurrencysym$amountz<br /><b>Status:</b> Solved<br /><b>Message:</b> $content
					  </p></td> 
                     </tr>
...
if(isset($_GET['decline'])){
    ...
    $query11 = "SELECT * FROM tickets WHERE ticketid='".$_GET['decline']."'";
        $result11 = $mysqli->query($query11); 
 $row11 = $result11->fetch_array();
 $amountpaid = $row11['amount'];
 $theamount_fm = number_format($amountpaid);
 $ticketid = $row11['ticketid'];
 $amount = $row11['amount'];
 ...
 $mycurrencysym = $row22['mycurrencysym'];
	...
	$update=$mysqli->query("UPDATE tickets SET "
						 . "status='declined'" . " WHERE ticketid=" .$_GET['decline']);
						 
						 
$message = 'Hello '.$dusername.', your deposit of '.$mycurrencysym.''.$theamount_fm.' was declined.';					 
$subject = 'DECLINED: Your Bank Deposit Ticket ['.$ticketid.'] Has Been Solved';
$datez = date('Y');
$email_message = <<<EOD
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" style="width:100%;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0">
               ...
               <table width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                 <tr style="border-collapse:collapse"> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:530px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     <tr style="border-collapse:collapse"> 
                      <td class="es-m-txt-l" align="left" style="padding:0;Margin:0;padding-top:15px"><h3 style="Margin:0;line-height:22px;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;font-size:18px;font-style:normal;font-weight:bold;color:#333333">Hello $userbro, Your ticket [$ticketid] has been declined and marked as solved.</h3></td> 
                     </tr> 
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-bottom:10px;padding-top:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">The deposit ticket of $mycurrencysym$amountz into your has been declined, kindly contact our support for more information on your deposit!<br /><br /><span style="color: red; font-weight: bold; font-size: 30px; display: block; text-align: center;">DECLINED</span><br />
                      <b>NOTE:</b> If you don't deposit such amount at this time, Kindly Contact us to secure your account or ignore the ticket mail, It will be closed automatically after 3 days!
                     </p></td> 
                     </tr>  
                     <tr style="border-collapse:collapse"> 
                 ...
                 <tr style="border-collapse:collapse"> 
                  <td valign="top" align="center" style="padding:0;Margin:0;width:530px"> 
                   <table width="100%" cellspacing="0" cellpadding="0" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"> 
                     ...
                     <tr style="border-collapse:collapse"> 
                      <td align="left" style="padding:0;Margin:0;padding-top:15px"><p style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:'open sans', 'helvetica neue', helvetica, arial, sans-serif;line-height:24px;color:#777777;font-size:16px">
					  <b>Ticket ID:</b> $ticketid<br /><b>Subject:</b> $title<br /><b>Amount:</b> $mycurrencysym$amountz<br /><b>Status:</b> Declined<br /><b>Message:</b> $content
					  </p></td> 
                     </tr>
...
?>
    ...
    <div id="main-wrapper">
					...
					<div class="col-xl-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Tickets (<?= number_format($alltickets);?>)</h4>
                            </div>
                            <div class="card-body">
        ...
        while ($transrow = $result->fetch_array()) {
			...
			$btc_amount = $transrow['btc_amount'];
            //$c++;
	...
	$trans_client=$row2['firstname'].' '.$row2['lastname'];
		...
		?>
                                            <tr>
                                                ...
                                                <td data-bs-toggle="modal" data-bs-target="#basicModal<?= $nuz;?>"><b><?= $ticketid;?></b></td>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="?delete=<?= $transactionid;?>" onclick="return confirm('Are you sure to Delete this Ticket? NOTE: This Action cannot be Undo!');" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>												
												</td>
...
<!-- Modal -->
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title">Ticket ID: <b>#<?= $transrow['ticketid'];?></b></h5>
  ...
  <path d="M5.933.87a2.89 2.89 0 0 1 4.134 0l.622.638.89-.011a2.89 2.89 0 0 1 2.924 2.924l-.01.89.636.622a2.89 2.89 0 0 1 0 4.134l-.637.622.011.89a2.89 2.89 0 0 1-2.924 2.924l-.89-.01-.622.636a2.89 2.89 0 0 1-4.134 0l-.622-.637-.89.011a2.89 2.89 0 0 1-2.924-2.924l.01-.89-.636-.622a2.89 2.89 0 0 1 0-4.134l.637-.622-.011-.89a2.89 2.89 0 0 1 2.924-2.924l.89.01.622-.636zM7.002 11a1 1 0 1 0 2 0 1 1 0 0 0-2 0zm1.602-2.027c.04-.534.198-.815.846-1.26.674-.475 1.05-1.09 1.05-1.986 0-1.325-.92-2.227-2.262-2.227-1.02 0-1.792.492-2.1 1.29A1.71 1.71 0 0 0 6 5.48c0 .393.203.64.545.64.272 0 .455-.147.564-.51.158-.592.525-.915 1.074-.915.61 0 1.03.446 1.03 1.084 0 .563-.208.885-.822 1.325-.619.433-.926.914-.926 1.64v.111c0 .428.208.745.585.745.336 0 .504-.24.554-.627z"/>
												...
												<hr />
											<p>Ticket ID: <b>#<?php echo $transrow['ticketid'];?></b></p>
...
<?php if($btc_amount>0){?><p>Bitcoin Amount: <b><?php echo $btc_amount;?> BTC</b></p><?php }?>

		<p>Type: <?= ucwords($trans_type);?></p>	
		<p>Status: <?= $statz2;?></p>		
		<p>Description: <?php echo $transrow['content'];?></p>	
		...
		<p>IP: <?= $trans_ip;?></p><?php }?>
												...
												<div class="row">
												    <div class="col-6"><a class="badge badge-success" style="width: 100%;" <?php if($trans_status=='closed'){echo 'disabled';}else{?>href="?approve=<?= $transrow['ticketid'];?>" onclick="return confirm('Are you sure you want to Approve this ticket? NOTE: This Action cannot be Undo!');"<?php }
												    ?>>Approve Ticket</a></div>
												    <div class="col-6"><a class="badge badge-danger" style="width: 100%;" <?php if($trans_status=='declined'){echo 'disabled';}else{?>href="?decline=<?= $transrow['ticketid'];?>" onclick="return confirm('Are you sure you want to Decline this ticket? NOTE: This Action cannot be Undo!');"<?php }?>>Decline Ticket</a></div>
												</div>
												</div>
