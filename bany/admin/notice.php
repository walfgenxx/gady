...
if(isset($_GET['clear']) ){
    ...
    $update=$mysqli->query("UPDATE users SET "
						 . "notice=''" . " WHERE userid=" .$_GET['clear']); header('Location: '.$_SERVER['HTTP_REFERER']);}						 ?>
    ...
    <div id="main-wrapper">
					...
					<div class="col-xl-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Users Notice (<?= number_format($allnotice);?>)</h4>
                            </div>
                            <div class="card-body">
        ...
        $query = "SELECT * FROM users WHERE creator='".$_SESSION['user']['userid']."' AND notice !='' ORDER by id DESC";
                                            ...
                                            <tr>
                                                ...
                                                <td>
													<div class="d-flex">
														...
														<a href="?clear=<?= $userrow['userid'];?>" onclick="return confirm('Are you sure to Clear this Notice? NOTE: This Action cannot be Undo!');" class="btn btn-danger shadow btn-xs"><i class="fa fa-trash"></i> Clear</a>
													</div></td>
</tr>
                                            <?php }?>
                                        </tbody>
